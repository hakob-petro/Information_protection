...
#ifdef ENABLE_SBOX_TABLE_ENCRYPT
...
#ifdef ENABLE_SBOX_TABLE_DECRYPT
...
#ifndef ENABLE_SBOX_TABLE_ENCRYPT
...
#else /* ENABLE_SBOX_TABLE_ENCRYPT */
static uint8_t aes_sbox(uint8_t a)
{
    return aes_sbox_table[a];
}
#endif /* ENABLE_SBOX_TABLE_ENCRYPT */

#ifndef ENABLE_SBOX_TABLE_DECRYPT
...
#else /* ENABLE_SBOX_TABLE_DECRYPT */
...
#endif /* ENABLE_SBOX_TABLE_DECRYPT */
